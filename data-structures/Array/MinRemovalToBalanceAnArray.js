/*You are given an array of integers and want to make it balanced. 
The array is balanced if the largest number is at most twice the smallest number. 
You are allowed to do the following: 
 • Remove any number of elements from the array.
 • Change at most one element to any positive integer you choose.
Find the minimum number of elements that must be removed so that the array becomes balanced,
Example 1 Input: err = [7, 4, 2, 3, 12, 9] Output: 2, 
Explanation: An optimal sequence of operations is: 
• Change the second element from 4 to 8. 
• Remove the third and fourth elements, 2 and 3. 
 The modified array is [7, 8, 12, 9] 
 12 is less than or equal to 2 x 7. 
Example 2 Input: arr = (4, 6, 2, 9, 8, 7, 3] Output: 2 
Explanation: "An optimal sequence of operations is: 
...
Constraints • 2s size of arr ≤2 * 105 1s arril s 109 */
